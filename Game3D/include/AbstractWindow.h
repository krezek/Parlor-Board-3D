...
#define WM_PROCESS_P1_MSG WM_USER + 1
#define WM_PROCESS_P2_MSG WM_USER + 2
...
#define EV_DICE1_JUST_ROLLED	0ULL
#define EV_DICE2_JUST_ROLLED	1ULL
#define EV_DICE1_CLICKED		2ULL
#define EV_STONE_P1_SELECTED	3ULL
#define EV_CLASS_DEFINED		1000ULL
...
public:
	...
	virtual void OnProcessP1Msg(WPARAM wp, LPARAM lp) = 0;
	virtual void OnProcessP2Msg(WPARAM wp, LPARAM lp) = 0;

	bool isPaused() { return _paused; }

	void FireProcessP1Msg(WPARAM wp, LPARAM lp = (LPARAM)0) { PostMessage(Window(), WM_PROCESS_P1_MSG, wp, lp); }
	void FireProcessP2Msg(WPARAM wp, LPARAM lp = (LPARAM)0) { PostMessage(Window(), WM_PROCESS_P2_MSG, wp, lp); }
